  ...
  astronvim.set_mappings(
    user_plugin_opts("lsp.mappings", {
      n = {
        ...
        ["gi"] = { "<cmd>Telescope lsp_implementations theme=ivy<CR>", desc = "Implementation of current symbol" },
        ["gd"] = { function() vim.lsp.buf.definition() end, desc = "Show the definition of current symbol" },
        ["gD"] = { function() vim.lsp.buf.type_definition() end, desc = "Declaration of current symbol" },
        -- ["gr"] = { function() vim.lsp.buf.references() end, desc = "References of current symbol" },
        ["gr"] = { "<cmd>Telescope lsp_references theme=ivy<CR>", desc = "References of current symbol" },
